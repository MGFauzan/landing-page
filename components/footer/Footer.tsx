...
import { PERSON, SOCIALS } from '@/constants/data';
            ...
            <div>
              ...
              {NAV.map((n) => (
                <div key={n} style={{ marginBottom: 8 }}>
                  <button
                    onClick={() => scrollTo(n)}
                    style={{ background: 'none', border: 'none', color: '#64748B', fontSize: 14, cursor: 'pointer', padding: 0, fontFamily: "'DM Sans',sans-serif", transition: 'color .2s' }}
